...
Articulation {
	...
	Branch {
		...
		RevoluteLink {
			Name		"upperarm"
			Graphics_Model	"mitsu_upperarm.xan"
		...
		RevoluteLink {
			Name		"forearm"
			Graphics_Model	"mitsu_forearm.xan"
		...
		RevoluteLink {
			Name		"wrist_pitch"
			Graphics_Model	"mitsu_wrist_pitch.xan"
