// RBModeler.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CRBModelerApp, CWinApp)
	//{{AFX_MSG_MAP(CRBModelerApp)
...
/////////////////////////////////////////////////////////////////////////////
// CRBModelerApp construction

CRBModelerApp::CRBModelerApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CRBModelerApp object

CRBModelerApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CRBModelerApp initialization

BOOL CRBModelerApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CRBModelerDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CModelListView));
...
/////////////////////////////////////////////////////////////////////////////
// CRBModelerApp message handlers
...
BOOL CAboutDlg::OnInitDialog() 
{
	...
	m_linkBugEmail.SetURL ("mailto:robotbuilderbugs@yahoo.com");
