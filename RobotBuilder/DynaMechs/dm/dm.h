...
inline void buildRotMat(Quaternion quat, RotationMatrix R)
{
   ...
   R[0][0] = (Float)(1.0 - (q3q3 + q2q2));
   R[1][0] = (Float)(q1q2 - q3q4);
   R[2][0] = (Float)(q1q3 + q2q4);

   R[0][1] = (Float)(q1q2 + q3q4);
   R[1][1] = (Float)(1.0 - (q3q3 + q1q1));
   R[2][1] = (Float)(q2q3 - q1q4);

   R[0][2] = (Float)(q1q3 - q2q4);
   R[1][2] = (Float)(q2q3 + q1q4);
   R[2][2] = (Float)(1.0 - (q2q2 + q1q1));
}
