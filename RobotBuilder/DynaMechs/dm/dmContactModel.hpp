...
private:
   ...
   CartesianVector *m_initial_contact_pos;  // ICS 1st pnt of contact for each
	int *m_point_IDs; // Used for tracking anchor points with the treadmill environment
   ...
   CartesianVector *m_initial_contact_pos_stored;
	int *m_point_IDs_stored; // Used for tracking anchor points with the treadmill environment
