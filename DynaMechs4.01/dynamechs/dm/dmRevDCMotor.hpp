...
\begin{verbatim}
    ...
    Motor_Gear_Ratio                   n
\end{verbatim}
Note that the {\tt setParameters} function has been provided to set these 
parameters under programmer control.  {\em I either need to add a getParameters function
or I need to implement individual get/set functions for each parameter.}
...
public:
   ...
   ///
   inline Float getRotorInertia() const { return m_rotor_inertia * (m_gear_ratio * m_gear_ratio); }
